...
garrow_fixed_shape_tensor_array_new(GArrowTensor *tensor, GError **error)
{
  ...
  //auto array_fixed_shape_tensor_array = *arrow_array_result;
...
//    g_object_new(GARROW_TYPE_EXTENSION_ARRAY, "storage", &arrow_array, nullptr));
//    g_object_new(GARROW_TYPE_ARRAY, "data-type", &arrow_array, nullptr));
//    g_object_new(GARROW_TYPE_FIXED_SHAPE_TENSOR_ARRAY, "storage", &arrow_array, nullptr));
//    g_object_new(GARROW_TYPE_FIXED_SHAPE_TENSOR_ARRAY, "storage", &arrow_array, nullptr));
//    g_object_new(GARROW_TYPE_ARRAY, "storage", &arrow_array, nullptr));
}
G_END_DECLS
